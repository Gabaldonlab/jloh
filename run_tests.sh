...
cd /gpfs/projects/bsc40/current/mschiavi/jloh/scripts
...
run_tests.nf \
-resume \
-work-dir /gpfs/projects/bsc40/current/mschiavi/jloh/scripts/work \
...
--output_dir /gpfs/projects/bsc40/current/mschiavi/jloh/results
